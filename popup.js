...
initialize(), addMultipleDelegatedEventListeners("body", "click", function(e, t) {
    ...
    var n = window.location.href + UNPRODUCTIVE_MODE_QUERY,
        a = window.innerWidth;
    ...
    var o = 40;
    var popup = window.open("", 'Unproductive Websites', "width=" + a + ",height=" + r + ",left=" + s + ",top=" + o + ",resizable=yes,location=no,menubar=no,scrollbars=no,status=no,titlebar=no,toolbar=no")
    popup.document.open();
    popup.document.write('<html><head><title>Unproductive Websites</title><link rel="stylesheet" type="text/css" href="/css/popup.css"></head><body>');
    popup.document.write(document.getElementById("unproductive").innerHTML);
