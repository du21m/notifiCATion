...
var domains = {},
    ...
    STORAGE_UNPRODUCTIVE_WEBSITES = "unproductive-websites",
    ...
    loadTimeUnproductive = function() {
        return storageLocal.load(STORAGE_UNPRODUCTIVE_TIME, UNPRODUCTIVE_TIME_DEFAULT, function(e) {
            settings.unproductiveTime = e[STORAGE_UNPRODUCTIVE_TIME], saveTimeUnproductive(), dcl("Unproductive time loaded: " + e[STORAGE_UNPRODUCTIVE_TIME])
        }), !0
    },
    ...
    loadUnproductiveWebsites = function() {
        return storageLocal.load(STORAGE_UNPRODUCTIVE_WEBSITES, [], function(e) {
            settings.unproductiveWebsites = e[STORAGE_UNPRODUCTIVE_WEBSITES], saveUnproductiveWebsites(), dcl("Unproductive websites loaded: " + e[STORAGE_UNPRODUCTIVE_WEBSITES])
        }), !0
    },
    saveUnproductiveWebsites = function() {
        return storageLocal.save(STORAGE_UNPRODUCTIVE_WEBSITES, settings.unproductiveWebsites, function() {
            dcl("Unproductive websites saved: " + settings.unproductiveWebsites)
        }), !0
    },
    setUnproductiveWebsites = function(e) {
        return settings.unproductiveWebsites = "map" == typeof e ? e : new Map(), !0
    },
...
}), dcl("Webtime Tracker - background.js loaded"), loadDateStart(dates.today), loadSecondsAlltime(), loadIdleTime(), loadGraphGap(), loadTimeUnproductive(), loadUnproductiveWebsites(), loadBadgeDisplay(), loadScreenshotInstructionsRead(), loadDomains(function(e) {
